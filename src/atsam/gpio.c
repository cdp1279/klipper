...
DECL_ENUMERATION_RANGE("pin", "PA", GPIO('A', 0), 32);
DECL_ENUMERATION_RANGE("pin", "PB", GPIO('B', 0), 32);
#ifdef PIOC
DECL_ENUMERATION_RANGE("pin", "PC", GPIO('C', 0), 32);
#endif
#ifdef PIOD
DECL_ENUMERATION_RANGE("pin", "PD", GPIO('D', 0), 32);
#endif
#ifdef PIOE
DECL_ENUMERATION_RANGE("pin", "PE", GPIO('E', 0), 32);
#endif
